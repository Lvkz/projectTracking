<?php
	...
	if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    	...
    	$query = 'INSERT INTO nivelesusuarios (id_nivel,tipoNivel, numeronivel, estado)' .
				 " VALUES ((SELECT cargarRegistro('NivelesUsuario')),'" . $_POST['nombre_nivel'] . "', " . $_POST['numero_nivel'] . ", true);";
